  ...
  return (
    ...
    >
      <div className="text-center mb-6">
        <h3 className="text-2xl font-bold text-gray-900 mb-2 tracking-tight">Create Account</h3>
        <p className="text-gray-500 text-sm">Join us today to start your journey.</p>
      </div>
